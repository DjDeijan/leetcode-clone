...
| --------------- | --------- |
| Деян Азми       | 471223014 |
| Виктор Достинов | 471223022 |
| Тодор Христов   | 471223048 |
| Йордан Кърпачев | 471223084 |

## От какво се състои проектът?
Нашият проект е нещо като barebones копие на leetcode, но само с backend, към който могат да се правят заявки чрез Swagger. В приложението има потребители с роли, които могат да се регистрират и логват. Потребителите могат да създават задачи (tasks) и да им назначават етикети (tags). Задачите могат да имат тестови случаи, където потребителят може да въведе за коя задача се отнася, примерен вход и изход, както и максимално време за изпълнение в милисекунди, максимална памет в кб и максимално пространство в стека пак в кб. Когато някой предаде решение на дадена задача, то бива пратено за оценяване към [Judge0](https://judge0.com/), като judge изпълнява кода и го оценява спрямо предварително зададени от създателя на задачата тестови случаи. След като решението е оценено, оценката бива записана, а ако има грешки, те също се записват.
...
## Postman
Информация за най-основните [API calls в judge0](https://www.postman.com/judge0/public/overview)
